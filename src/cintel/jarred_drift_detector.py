...
OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "drift_summary_jarred.csv"
SUMMARY_LONG_FILE: Final[Path] = ARTIFACTS_DIR / "drift_summary_long_jarred.csv"
...
def main() -> None:
    ...
    # --- MODIFICATION  ---
    # Calculate total number of drifting metrics
    drift_df = drift_df.with_columns(
        (
